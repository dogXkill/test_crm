            ...
            <table cellspacing="3" cellpadding="4" border="0">
              <tbody>
                <tr>
                  ...
                  <td><input name="post_name" id="post-name" type="text" size="30" value=""/></td>
                </tr>
              <!--  <tr>
                  <td align="right">����������:</td>
                  <td><span class="err">*</span></td>
                  <td><input name="post_sort" id="post-sort" type="text" size="30" value=""/></td>
                </tr>-->
              </tbody>
          </table>
          </form>
      ...
      /*  var sort = Number(document.getElementById('post-sort').value);
        ...
        if (errors == '' || errors == null) {
          ...
          //  data: {new: 1, name: name, sort: sort},
            data: {new: 1, name: name},
            dataType: 'html',
            async: false,
            success: function(data){
              alert('��������� ���������!');
                window.location = 'index.php';
              //  setTimeout(() => {window.location = '/acc/sprav/user_posts/edit.php?id=' + data}, 1000);
            }
          });
        } else {
          alert (errors);
