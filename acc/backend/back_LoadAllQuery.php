...
$arr_all_data['date_query'] =  date('d.m.Y H:i', strtotime($r['date_query']));
...
$arr_all_data['corsina_order_num'] = $r['corsina_order_num'];
$arr_all_data['booking_till'] = $r['booking_till'];
// предмет счета
...
while($r = mysql_fetch_array($res)) {
	...
	$arr_all_data['predm']['list'][$i]['tip_izd']=$r['tip_izd'];
	$arr_all_data['predm']['list'][$i]['tip_sdelki']=$r['tip_sdelki'];
	$i++;
}
