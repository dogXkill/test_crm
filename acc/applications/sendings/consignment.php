<?
header("Expires: Mon, 26 Jul 1997 05:00:00 GMT"); //Р”Р°С‚Р° РІ РїСЂРѕС€Р»РѕРј
...
<body>
  ...
  <div id="app"></div>
  <script type="text/babel" data-id="<?=$id?>" id="invoiceScript" src="js/consignment.js?cache=<?=$rand?>" charset="utf-8"></script>
</body>
</html>
<? ob_end_flush() ?>
