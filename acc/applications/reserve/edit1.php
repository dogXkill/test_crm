      	...
      	<tr>
      		<td valign="top" align="center">
      			<table width="90%" border=0 cellspacing="0" cellpadding="0">
      				<tr id="top_menu">
					<td width="300"><a href="list.php" class="sublink"><img src="../../i/manufacture.png" width="24" height="24" alt=""  style="vertical-align: middle;"/></a>
<a href="list.php" class="sublink">Список заявок</a></td>
      					<td width="300" align=center>
<a href="list.php" class="sublink"><img src="../../i/manufacture.png" width="24" height="24" alt=""  style="vertical-align: middle;"/></a> <a href="edit.php" class="sublink">Добавить заявку</a>
</td>
</tr>
...
<span id="app_type_span"><input type="hidden" id=uid name=uid />
Тип заявки:<br>
...
<option value="3">заказ у внешнего поставщика</option>
</select>
</span>
...
<div id=ClientName_span>Название клиента (или проекта): <input type="text" id="ClientName" name=ClientName size=5 value="<?=$client_name;?>"  style="width:250px"/ required> <a href="/acc/query/query_send.php?show=<?=$zakaz_id;?>" target="_blank"><img src="../i/lupa.gif" width="20" height="20" alt=""></a>
...
Тип продукции:
<select id="izd_type" name=izd_type style="width:250px" onchange="jump('izd_type','1','tiraz');search_similar_art()" required >
...
В: <input type="text" style="width:100px;" id="izd_v" name="izd_v" onkeyup="jump('izd_v','2','izd_b');this.value=replace_num(this.value);" onchange="search_similar_art()" size=3 required/>
Б: <input type="text" style="width:100px;" id="izd_b" name="izd_b" onkeyup="jump('izd_b','2','izd_material');this.value=replace_num(this.value);" onchange="search_similar_art()" size=3 required/>
...
грамм:
<input type="text" style="width:50px" id="izd_gramm" name="izd_gramm" maxlength=4 onkeyup="jump('izd_gramm','3','paper_suppl');this.value=replace_num(this.value);" required/>
<br>
комментарий:
...
<!-- НУЖНО ЛИ ЭТО????????? -->
<input type="hidden" id="vip111" name="vip111" value="0" />
<!-- НУЖНО ЛИ ЭТО????????? -->
<br>
...
<input type="button" value="сверить с/с с сайтом >>>" style="height:30px" onclick="get_art_info('compare_ss')" />
...
<tr>
<td><?=$jn["name"];?></td>
<td><input class="tx" onkeyup="this.value=replace_zap(this.value);"  name="<?echo "rate_".$jn["id"];?>" id="<?echo "rate_".$jn["id"];?>" type="text" size="8" value="<?$rate_id = "rate_".$jn["id"]; if(!$r_apl[$rate_id]) {echo $jn["price"];}else{echo $r_apl[$rate_id];}?>" /></td>
</tr>
<?}?></td></tr>
</table>
<?}?>
...
<?if(is_numeric($uid)){?>
<input onclick="print_app();" type="button" id="print_but" value="Распечатать!" style="width: 400px; cursor:pointer; height: 70px; font-size: 30px;">
<?}?>
</span>
</form>
...
//блокируем возможность смены типа заказа
$("#app_type").val(1);
