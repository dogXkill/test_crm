...
function get_sdelka(job_id, act){
if(act == "get_sdelka"){$('#load_img_'+job_id).attr('src', '../../../../i/load.gif');}
var geturl;

  geturl = $.ajax({
    type: "GET",
    url: '../backend/job_entries1.php',
	data : '&year=<?=$year;?>&month=<?=$month;?>&act='+act+'&num_sotr='+job_id,
    success: function () {
