...
<img src="../../../i/vedomost.png" width="22" height="22" alt="" align="absmiddle" onclick="report_div()"></a>
...
window.location.href = '/acc/applications/timetable/report.php?type=<?=$_GET["type"]?>&year='+year+'&month='+month;
}
function report_div(){
