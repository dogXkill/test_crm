...
<td class="table_title" style="width:100px">Сделка <img src="../../i/refresh.png" width="16" height="16" alt="" onclick="get_full_sdelka('get_sdelka')" style="cursor:pointer;"><br><input type="checkbox" id="save_sdelka" name="save_sdelka"/> <label for="save_sdelka" style="cursor:pointer">сохр.</label></td>
