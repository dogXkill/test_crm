...
$report = mysql_query("SELECT * FROM report2 WHERE pay1date='$date' OR  pay2date='$date' OR  pay3date='$date' OR  pay4date='$date' OR  pay5date='$date' OR  pay6date='$date' OR  pay7date='$date'");
